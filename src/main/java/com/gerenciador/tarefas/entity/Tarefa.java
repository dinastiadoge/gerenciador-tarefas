...
public class Tarefa implements Serializable {
    ...
    public Tarefa(Long id, String titulo, String descricao, TarefasStatusEnum status, Usuario responsavel, Usuario criador, int quantidadeHorasEstimadas, Integer quantidadeHorasRealizada, LocalTime dataCadastro, LocalTime dataAtualizacao) {
        this.id = id;
        this.titulo = titulo;
